...
<script	src="resources/js/pjpostingSearch_Sample.js"
		type="text/javascript"></script>
...
.hoverSearchResultTable tr:hover {
	background-color: #ffff99;
	font-weight: bold;
	cursor: pointer;
}
	...
	$(window).ready(
			function() {
				...
				$('#searchendday').datepicker(
						...
						"onClose",
						function(selectedDate) {
							$("#searchstartday").datepicker("option",
									"maxDate", selectedDate);
						});
				$('#inputperiod_1').datepicker();
				$('#inputperiod_1').datepicker("option", "maxDate",
						$("#inputperiod_2").val());
				$('#inputperiod_1').datepicker(
						"option",
						"onClose",
						function(selectedDate) {
							$("#inputperiod_2").datepicker("option", "minDate",
									selectedDate);
						});
					...
					<tbody>
						...
						<tr>
							...
							<td><input type="text" style="width: 45%;"
								id="searchstartday" name="searchstartday" class="inputDate" />~<input
								type="text" style="width: 45%;" id="searchendday"
								name="searchendday" class="inputDate" /></td>
					...
					<table style="table-layout: fixed;">
						...
						<tr>
							...
							<td><input type="text" style="width: 120px"
								id="inputperiod_1" placeholder="ex) 0000-00-00" /></td>
							<td><input type="text" style="width: 120px"
								id="inputperiod_2" placeholder="ex) 0000-00-00" /></td>
							<td hidden id="division"></td>
						</tr>
					</table>
					<br /> 
					<input type="button"
						style="margin-left: 342px; padding-left: 20px; padding-right: 20px;"
						value="검색" id="historySearch" /> 
						<!--   -->
						<input type="button"
						style="margin-left: 20px; padding-left: 20px; padding-right: 20px;"
						value="삭제" id="historydelete" /> 
						<input type="button"
						style="margin-left: 20px; padding-left: 20px; padding-right: 20px;"
						value="취소" id="historycancle" />
				</div>
				<div class="content">
					<p class="subTitle">◈검색 결과</p>
					<table>
						<colgroup>
							<col style="width: 120px;" />
							<col style="width: 120px;" />
...
<!-- 							<tr>
					...
					<div style="max-height: 100px; overflow-y: auto; width: 378px">
					<table class="hoverSearchResultTable">
						<colgroup>
							<col style="width: 120px;" />
							<col style="width: 120px;" />
							<col style="width: 120px;" />
						</colgroup>
						<thead class="hoverSearchResultTableThead">
