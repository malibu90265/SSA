...
<body>
	...
	<div class="container">
		...
		<p style="margin-bottom:5px"><input type="button" id="excelExport" value="Excel"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		※ 참고사항 : 매출원가 미배치 인건비 미반영 <fmt:formatNumber value="${vo.no_place_cost}"
		pattern="#,###" /> 천원   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		=> 매출원가 미배치 인건비 반영 시 영업이익 : <fmt:formatNumber value="${vo.sum_ebit-vo.no_place_cost}"
		pattern="#,###" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;단위 : [천원]</p>
		<div id="totalchart">
	<table id="total" width="1300px">
