...
<body>
	...
	<div class="container"margin-top:30px;>
		...
		<div id="wrap" style="width: 2100px; margin: auto; margin-top: 30px;">
			...
			<div id="main" style="margin-top: 30px;">
				<div id="left_main"
					...
					<table style="width: 480px">
						<tr>
							...
							<td><select style="width: 100%" name="searchteam"
								id="searchcus">
									<option value="">선택하세요
							...
							<td><input style="width: 96%" type=text name=searchname
								id=searchid></td>
						</tr>
					</table>
					<div
						style="text-align: right; width: 580px; margin-top: 5px; margin-bottom: 18px; margin-right: 10px">
				...
				<div id="right_main"
					style="height: 600px; width: 650px; background: white; float: left; margin-left: 90px; margin-top: 4%">
					<form name="userForm" method="post">
						<table style="width: 550px">
							...
							<tr>
								...
								<td><select style="width: 100%; height: 100%"
									id="customer_div"><option value="">선택하세요
										<option value=0>수주계약
										<option value=1>외주업체
										<option value=2>상품판매</select></td>
							</tr>
							<tr>
								<th style="width: 150px; height: 25px">고객 명*</th>
								<td style="width: 200px"><input type="text"
									name="customer_name" id="customer_name" style="width: 98%"
									placeholder="ex)KT" /><input type="text" id="h_name" hidden></td>

							</tr>
							<tr>
								<th style="height: 25px">신용등급</th>
								<td><input style="width: 98%; height: 100%;" type="text"
									name="customer_credit" id="customer_credit" /></td>
							</tr>
							<tr>
								<th style="height: 25px">사업자 등록번호</th>
								<td><input type="text" name="customer_name"
									id="customer_regno"
									style="width: 98%; height: 100%; ime-mode: disabled;"
									placeholder="10자리" />
							</tr>
							<tr>
						...
						<div style="margin-left: 55%; margin-top: 7px;">
							<input type="button" value="저장" id="update" />&nbsp;&nbsp; <input
								type="button" value="삭제" id="delete" disabled=true />&nbsp;&nbsp;
