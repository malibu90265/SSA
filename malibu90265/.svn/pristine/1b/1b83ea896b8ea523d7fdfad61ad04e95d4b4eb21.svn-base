...
<body>
	<div class="container">
		<section class="contents" style="width: 1600px;">
			<h1 class="contentsTitle">인력 정보 관리</h1>
			<span class="endlabel"></span> <section>
			<div style="width: 600px; float: left;">
				<div id="left_main" style="width: 600px; margin-right: 10px; float: left;">
				...
				<table style="width: 600px;" id="searchtable">
					<tr>
						...
						<td><select name="searchyear" id="searchyear"
							style="height: 30px; width: 99%;"></select></td>
					</tr>
					<tr>
						<th align="right" style="height: 30px;">직 급</th>
						<td><select id="searchposition" name="searchposition"
					...
					<tr>
						...
						<td><select name="searchskill" id="searchskill"
							style="height: 30px; width: 99%;">
						...
						<td>
							...
							<input type="checkbox" id="envclass_c" name="envclass_c"
							value="C">C <input type="checkbox" id="envclass_w"
							name="envclass_w" value="W">W <input type="checkbox"
							id="envclass_m" name="envclass_m" value="M">M
						</td>
					</tr>
					<tr>
						<th style="height: 30px" align="right">직원구분</th>
						<td><select id="searchdiv" name="searchdiv"
							style="height: 30px; width: 99%">
						...
						<td><select id="searchskill2"
							style="height: 30px; width: 99%" name="searchskill2nd"></select></td>
					</tr>
				</table>
				<p>
		...
		<div
			style="width: 750px; float: left; margin-left: 55px; margin-top: 10px;">
			<!-- <form method="post" name="frm" action="insert.iqshr" enctype="multipart/form-data"> -->
			<form method="post" name="frm" enctype="multipart/form-data">
				<table>
					<tr>
						<th style="width: 280px; height: 30px;" align="right">직원/외주 선택 </th>
						<td style="width: 410px; height: 30px;" align="left">
							<input type="radio" name="division" id="emp_form" value="직원" checked onchange="change('E')"> 직원 
							<input type="radio" name="division" id="out_form" value="외주" onchange="change('O')" onclick="setMpm()">외주<font class="emp_duplication"></font>
						</td>
				...
				<P>
				<div
					style="float: left; width: 718px; height: 660px; overflow-y: auto;">
					<table style="font-size: 5" width="700px;" height="650px"
						id="emptable">
						<tbody>
							<tr>
								<td style="width: 175px; height: 210px;" align="center"
									rowspan="4"><img src="resources/images/emp_nophoto.jpg"
									id=emp_photo width="160px" height="210px" name="photo22"><br>
									<input style="width: 99%" type=file id="upload" name="photo11"
									onchange="empPictureUpload(event)" /></td>
								...
								<td><input style="width: 99%; height: 100%" type="text"
									id="emp_name" name=name /> <input type="text" id="h_name"
									hidden /></td>
							</tr>
							<tr>
								<th height="60px" align="right">소&nbsp;속&nbsp;&nbsp;</th>
								<td><input style="width: 99%; height: 100%" type="text"
									id=emp_company value="SQI소프트(주)" name=company disabled></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="text"
									style="border: 0; width: 40%; height: 100%; text-align: right;"
									id="career_date_Y" name="career_date_Y" value=""
									placeholder="YY" onkeydown="salaykeycheck()">년 <input
									style="border: 0; text-align: right; width: 40%; height: 100%"
									type="text" id="career_date_M" name="career_date_M" value=""
									placeholder="MM" onkeydown="salaykeycheck()">월</td>
							</tr>
							<tr id="to">
								<th colspan="2" align="right" id=timeoff>휴&nbsp;직&nbsp;일&nbsp;&nbsp;</th>
								<td align="left"><input type="checkbox" id="time_off"
									name="time_off" value="0" onclick="tock()">휴직 &nbsp; <input
									type="text" id="to_start_day" style="width: 38%; height: 100%"
									name="to_start_day"> ~ <input type="text"
									id="to_end_day" style="width: 38%; height: 100%"
									name="to_end_day"></td>
							</tr>
							<tr id="off">
								<th colspan="2" align="right" id=quit_title>퇴&nbsp;사&nbsp;일&nbsp;&nbsp;</th>
								<td align="left"><input style="width: 99%; height: 100%"
									type="text" id=quit_date name="quit_date"></td>
							</tr>
							<tr>
								<th colspan="2" align="right" id=phonenum_title>연&nbsp;락&nbsp;처&nbsp;&nbsp;</th>
								<td align="left"><select style="width: 30%; height: 100%"
									id="emp_phonenum1" name="phonenum1">
										<option value="010" selected="selected">010</option>
										<option value="011">011</option>
										<option value="016">016</option>
										<option value="017">017</option>
										<option value="02">02</option>
								</select> - <input style="width: 30%; height: 100%" type="text"
									id=emp_phonenum2 name="phonenum2" onkeydown="salaykeycheck()" />
									- <input style="width: 30%; height: 100%" type="text"
									id=emp_phonenum3 name="phonenum3" onkeydown="salaykeycheck()" /></td>
							</tr>
							<tr>

								<th colspan="2" align="right" id=position_title>직&nbsp;급 *</th>
								<td align="left"><select style="width: 48%; height: 100%"
									id="emp_position" name="position"></select> <select
									style="width: 48%; height: 100%" id="emp_grade" name="grade">
										<option value="">선택하세요
										<option value="6특급">특급
										<option value="7고급">고급
										<option value="8중급">중급
							...
							<tr>
								...
								<td align="left"><input type="text" id="emp_salary"
									name="emp_salary" value="" style="width: 99%; height: 100%;" />
								</td>
							</tr>
							<tr>
							...
							<tr>
								<th colspan="2" align="right" id=area_title>거&nbsp;주&nbsp;지
									*</th>
								<td align="left"><div id="area" name="area"
										style="height: 100%"></div></td>
							</tr>

							<tr>
								<th colspan="2" align="right" id="email_title">E-mail *</th>
								<td><input type="text" id=emp_email
									style="text-align: right; border: 0; width: 59%; height: 100%"
									name=email> <font id="mail_form">@sqisoft.com</font></td>
							</tr>
							<tr>
								<th colspan="2" align="right">기반&nbsp;분류&nbsp;&nbsp;</th>
								<td align="left" colspan="2"><input type="checkbox"
									id="envclass" name="envclass" value="C">C <input
									type="checkbox" id="envclass" name="envclass" value="W">W
							...
							<tr>
								...
								<td align="left">
									<!--  <div id="skill_div"></div> --> <select id="skill"
									name="skill" style="width: 100px;">
										<option value="" selected="selected">선택하세요</option>
										<option value="SERVER">SERVER</option>
										<option value="UI">UI</option>
										<option value="DB">DB</option>
				...
				<div style="margin-left: 69%;">
					...
					<input type="button" value="비우기" id="rst_btn" />
				</div>
			</form>
		</div>
		</section>
...
<script type="text/javascript">
	...
	function calendar() {
		...
		$('#to_start_day').datepicker("option", "maxDate",
				$("#to_end_day").val());
		$('#to_start_day').datepicker(
				"option",
				"onClose",
				function(selectedDate) {
					$("#to_end_day").datepicker("option", "minDate",
							selectedDate);
				});
