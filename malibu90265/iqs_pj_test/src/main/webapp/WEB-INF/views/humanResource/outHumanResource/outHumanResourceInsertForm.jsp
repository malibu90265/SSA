...
<style>
	#samePersonCheckBtn {width: 20%; cursor: pointer; text-align: center;}
</style>
</head>
<body>

	<div>
		<form:form commandName="humanResourceVO" id="outHumanResourceInsertForm" name="outHumanResourceInsertForm" enctype="multipart/form-data" method="post" >
			<table id="cssTable">
				<tr><th colspan="4" align="right"><span style="color:red;">*</span> : 필수 입력입니다.</th></tr>
				<tr align="right">
					<td rowspan=6 style="text-align:center" >
						<img	id="imagePreview" src="<c:out value="/resources/employee/emp_nophoto.jpg"/>" 
								style="width: 15vh; height: 15vh; width: 15vm; height: 15vm; float:center; clear:both;"/>
					</td>
				...
				<tr align="right">
					...
					<td colspan="2">
						<input type="text" name="hr_company" id="hr_company" style="width:100%;"/>
					</td>
				</tr>
				<tr align="right">
					<th>소속팀</th>
				...
				<tr align="right"> 
					<th>이메일</th>
					<td colspan="2">
						<input type="text" name="hr_email" id="hr_email" style="width:100%;" placeholder="id@email.com"/>
					</td>
				</tr>
				<tr align="right">
					<th>핸드폰번호</th>
				...
				<tr align="right">
					...
					<th>현재단가 <span style="color:red;">*</span></th>
					<td>
						<input type="text" name="hr_uprice" id="hr_uprice" placeholder="숫자를 입력해주세요." value="0" style="width:100%;"/>
					</td>
				</tr>
				<tr align="right">
					<th>이전단가 기준일</th>
					...
					<th>현재단가 기준일 <span style="color:red;">*</span></th>
					<td>
						<input type="text" id="hr_upd" name="hr_upd" style="width:100%;"/>
					</td>
				</tr>
				<tr align="right">
				...
				<tr align="right">
					...
					<td>
						<!-- 계산 -->
						<input type="text" id="hr_sqi_career" name="hr_sqi_career" placeholder="숫자를 입력해주세요." style="width:90%;" value="0"/>년
					</td>
				</tr>
				<tr align="right">
					<th>최종출신교</th>
				...
				<tr align="right">
					...
					<td>
						<select name="hr_nomal_abc"> 
							<c:forEach var="rank" items="${pdAbcOptions.keySet() }">
								<option value="${rank }" >${pdAbcOptions.get(rank) }</option>
							</c:forEach>
						</select>
					</td>
					<th>외주평가 : 인성 평가</th>
