...
<body>
	<form:form commandName="budgetVO" id="pjBudgetModifyForm" name="pjBudgetModifyForm" method="post">
		<table class="inputbordered">
			<tr>
				<th>프로젝트ID(수정)</th>
				<td style="text-align: left;">${budgetVO.pj_id}<input type="hidden" name="pj_id" id="pj_id" value="${budgetVO.pj_id}"/></td>
			</tr>
		</table>
		...
		<table class="inputbordered right" style="margin-top: 10px;">
			<tr>
				...
				<td style="text-align: left;">
					<input type="text" id="pb_no" name="pb_no" value="${budgetVO.pb_no}"/>
					<input type="hidden" name="original_pb_no" value="${budgetVO.pb_no}"/>
				</td>
			</tr>
			<tr>
				<th>예산 등록일</th>
	...
	<c:choose>
		<c:when test="${message=='pass' }">
			<div id="bottomLine">
				...
				<span id="pjBudgetModifyBtn">저장</span> 
