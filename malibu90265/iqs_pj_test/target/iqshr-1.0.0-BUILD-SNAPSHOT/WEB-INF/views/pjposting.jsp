	...
	<div class="container">
		...
		<div style="width: 1900px; margin: auto;">
			<div id="main" style="margin-top: 10px;">
				<div id="left_main"
					style="height: 600px; width: 400px; background: white; margin-right: 20px; float: left;">
					<strong><font size=3 color="#000075">◈ 프로젝트 목록 </font></strong>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<table>
						...
						<tr>
							...
							<td><input type="text" style="width: 45%;"
								id="searchstartday" name="searchstartday" />~<input type="text"
								style="width: 45%;" id="searchendday" name="searchendday" /></td>
						</tr>
				 ...
				 <input type="button" style="margin-bottom: 5px;margin-top: 5px; margin-left: 303px;" value="프로젝트 검색" id="pjsearchbutton" />
					<br>
					<table width="400px" cellspacing="1" cellpadding="0" border="0"
						class="hoverTable">
						<tr>
					...
					<div id="search_result"
						style="width: 422px; height: 600px; overflow-y: auto"></div>
				</div>
				...
				<div style="width: 960px; float: left; margin-left: 20px;">
					...
					<strong><font size=3 color="#000075">&nbsp;&nbsp;&nbsp;◈ 프로젝트 인력배치 </font></strong>	</div>
					<div style="float: left" id="pj_detail_res">
					<!-- 	<table border="1" style="width: 650px; margin-bottom: 10px;">
							<tr>
								<th align="center" style="width: 190px" colspan="3">프로젝트 ID</th>
								<td align="center" colspan="3" id="pj_id"></td>
								<th align="center" style="width: 190px" colspan="3">요구인원 수</th>
								<td align="center" ></td>
								<p>
							</tr>
							<tr>
								<th align="center" style="width: 65px;">특</th>
								<td align="center" style="width: 65px;"></td>
								<th align="center" style="width: 65px;">고</th>
								<td align="center" style="width: 65px;"></td>
								<th align="center" style="width: 65px;">중</th>
								<td align="center" style="width: 65px;"></td>
								<th align="center" style="width: 65px;">초</th>
								<td align="center" style="width: 65px;"></td>
								<th align="center" style="width: 65px;">기능</th>
								<td align="center" style="width: 65px;"></td>
							</tr>
							<tr>
								<th align="center" style="width: 130px; height: 63px" colspan="2">기술환경</th>
								<td align="center" style="width: 520px" colspan="9">-</td>
							</tr>
							<tr>
								<th align="center" style="width: 130px" colspan="2">프로젝트 기간</th>
								<td align="center" colspan="4"></td>
								<th align="center" style="width: 130px;" colspan="2">근무지
								<td align="center" style="width: 130px;" colspan="2"></td>
							</tr>
					...
					<!-- 		<tr>
							...
							<div id="pj_need_detail"  scrolling="no" style="overflow-y: auto;width:670px;height:105px;margin-bottom: 20px;">
							</div>
						</div><div style=" float: right; margin-top:120px;margin_left:20px;">
					...
					<div style="height: 600px; float: left;">
						<div style="width: 1100px; margin-left: px; margin-bottom: 5px">
							 <strong><font size=3 color="#000075">&nbsp;&nbsp;&nbsp;◈
									프로젝트 투입 현황</font></strong>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<strong><font size=3 color="#000075">&nbsp;&nbsp;&nbsp;
							◈ 프로젝트 배치 예정</font></strong>
						...
						<div id="pjposting_result"
							style="height: 210px; width: 1170px; overflow-y: auto;"></div><!-- 데이터들 불러오는 곳 가로 조정 하기   -->	
					
						<div align="center" style="margin-top: 7px;">
						<input type="button" id="pjpostingsave" value="저장" style="margin-left:650px;"/>
							&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" id="pjpostingcancle" onclick = "pjpostingcancle()"
								value="취소" /><br>
							<img src="resources/images/up.png"
								style="width: 30px; cursor: pointer" onclick="moveUp()" />
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <img
								src="resources/images/down.png"
								style="width: 30px; cursor: pointer" onclick="moveDown()" />
						</div>
						...
						<div style="margin-bottom: 5px">
							<br> <strong><font size=3 color="#000075">&nbsp;&nbsp;&nbsp;◈
									배치 대상자</font></strong> &nbsp;&nbsp; <input type="button" value="인원 검색"
								onclick=location.href="javascript:OpenWindow('searchEmpl.do','640px','600px')">
								<strong><font size=3 color="#000075">&nbsp;&nbsp;이름 검색 : </font></strong><input type="text" id="searchAny"/>
						</div>
						<TABLE class="fuck" cellpadding="0" cellspacing="0" border="0">
							<TR>
								<TD>
									<table style="width: 1152px;" cellspacing="1" cellpadding="0" border="0"
									class="hoverTable">
										<tr>
							...
							<tr>
								<td>
									<div id="res" style="height: 165px; width: 1170px; overflow-y:auto; " >
										<table style="width: 1152px;" id="ready" cellspacing="1" cellpadding="0" border="0"
									class="hoverTable" >
											<tbody id="posting1_tbd_movedown">
											</tbody>
											<tbody id="posting1_tbd">
											
										<!-- <c:forEach items="${requestScope.list}" var="empl">
													<tr>
														<td style="border-top:0; width: 21px;" align="center"><input type="checkbox"></td>
														<td style="border-top:0; width: 106px;" align="center">${empl.name}</td>
														<td style="border-top:0; width: 72px;" align="center">${empl.division}</td>
														<td style="border-top:0; width: 72px;" align="center">${empl.grade.substring(1,3)}</td>
														<td style="border-top:0; width: 120px;" align="center">${empl.cpid}</td>
														<td style="border-top:0; width: 115px;" align="center">${empl.cpendday}</td>
														<td hidden style="border-top:0;background-color: white; width: 120px;" align="center">${empl.use_skill}</td>
														<td style="border:0; width: 75px;" align="center"></td>
														<td style="border-top:0; width: 120px;" align="center">${empl.apid}</td>
														<td style="border-top:0; width: 97px;" align="center">${empl.apstartday}</td>
														<td style="border-top:0;" align="center">${empl.skill_name}</td>
														<td style="border-top:0; width: 135px;" align="center">${empl.e_area}</td>
...
<script type="text/javascript">
	...
	function calendar() {
		...
		$('#searchstartday').datepicker("option", "maxDate",
				$("#searchendday").val());
		$('#searchstartday').datepicker(
				"option",
				"onClose",
				function(selectedDate) {
					$("#searchendday").datepicker("option", "minDate",
							selectedDate);
				});
